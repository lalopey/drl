...
The problem is solved by using a Multiple Agent Deep Deterministic Policy Gradient (MADDPG) architecture. The specifics of the model and the results can be found in:

To run the model, run the [collab_maddpg_tennis.py](https://github.com/lalopey/drl/blob/master/3%20-%20Collab%20-MADDPG/collab_maddpg_tennis.py)
